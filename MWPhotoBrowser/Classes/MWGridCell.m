...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        _imageVideoIconView.frame = CGRectMake(5, 5,15, 10);
        ...
        _labelDuration.font=[UIFont systemFontOfSize:12.0];
        _labelDuration.frame = CGRectMake(self.frame.size.width-55, self.frame.size.height-18, 50, 15);
...
- (void)layoutSubviews {
    ...
    _imageVideoIconView.frame = CGRectMake(5,self.bounds.size.height- _imageVideoIconView.frame.size.height-5, _imageVideoIconView.frame.size.width, _imageVideoIconView.frame.size.height);
}
